...
def orth_triangle(cathetus1: Union[int, float] = 0, cathetus2: Union[int, float] = 0, hypotenuse: Union[int, float] = 0) -> Union[float, None]:
    if cathetus1 and hypotenuse:
        return ((hypotenuse**2) - (cathetus1**2))**0.5
    elif cathetus1 and cathetus2:
