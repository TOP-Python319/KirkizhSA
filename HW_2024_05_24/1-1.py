...
# 1. Конструктор __init__ был правильно реализован для создания атрибута экземпляра total_cents на основе входных аргументов dollars и cents.
# 2. Свойства-геттеры и свойства-сеттеры для атрибутов dollars и cents были верно созданы с использованием декораторов @property и @dollars.setter, @cents.setter.
# 3. В свойствах-сеттерах dollars и cents была реализована проверка вводимых данных и печаталось сообщение об ошибке, если значение не удовлетворяло условию.
# 4. Метод __str__ был верно реализован для возврата строки с информацией о состоянии экземпляра класса Money.
